    ...
    ru = {
        ...
        },
        {
            ...
            body = {
                ...
                { t = "ULX и sAdmin также могут стать серверной системой прав Talksmith. Ultimate Logs не является логикой диалога: он только включает защищённый журнал на странице «Сервер»." },
            },
        },
        {
            head = "Wiremod",
        ...
        },
        {
            ...
            body = {
                ...
                { t = "«Права»: минимальные группы для операций Talksmith. Страница появляется при поддерживаемой административной системе." },
        ...
        },
        {
            ...
            body = {
                ...
                { t = "При ULX или sAdmin супер-администратор выбирает минимальную группу; наследование и иммунитет проверяются сервером при каждой чувствительной операции." },
                { t = "Без поддерживаемой административной системы все административные операции доступны только superadmin. Superadmin всегда сохраняет доступ." },
    ...
    en = {
        ...
        },
        {
            ...
            body = {
                ...
                { t = 'ULX and sAdmin can also back Talksmith server permissions. Ultimate Logs is not dialogue logic; it only enables protected logging on the "Server" page.' },
            },
        },
        {
            head = "Wiremod",
        ...
        },
        {
            ...
            body = {
                ...
                { t = '"Permissions": minimum groups for Talksmith operations. This page appears with a supported administration system.' },
        ...
        },
        {
            ...
            body = {
                ...
                { t = "With ULX or sAdmin, a super administrator chooses minimum groups; inheritance and immunity are evaluated on the server for every sensitive operation." },
                { t = "Without a supported administration system, administrative operations are superadmin-only. Superadmins always retain access." },
